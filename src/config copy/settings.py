...
class Settings:
    ...
    # ENVIRONMENT
    # ========================================================================
    ENV: str = field(default_factory=lambda: os.getenv("BIOREMPP_ENV", "development"))

    # ========================================================================
    # SERVER CONFIGURATION
    # ========================================================================
    DEBUG: bool = field(default_factory=lambda: _get_bool("BIOREMPP_DEBUG", True))

    HOT_RELOAD: bool = field(
        default_factory=lambda: _get_bool("BIOREMPP_HOT_RELOAD", True)
    )

    HOST: str = field(default_factory=lambda: os.getenv("BIOREMPP_HOST", "127.0.0.1"))

    PORT: int = field(default_factory=lambda: _get_int("BIOREMPP_PORT", 8050))

    # ========================================================================
    # GUNICORN (PRODUCTION)
    # ========================================================================
    WORKERS: int = field(default_factory=lambda: _get_int("BIOREMPP_WORKERS", 4))
    ...
    TIMEOUT: int = field(default_factory=lambda: _get_int("BIOREMPP_TIMEOUT", 60))

    KEEPALIVE: int = field(default_factory=lambda: _get_int("BIOREMPP_KEEPALIVE", 5))
    ...
    UPLOAD_ALLOWED_EXTENSIONS: list = field(default_factory=lambda: [".txt"])
    ...
    KO_PATTERN: str = field(
        default_factory=lambda: os.getenv(
            "BIOREMPP_KO_PATTERN", r"^K\d{5}$"  # K + 5 digits
        )
    )
    ...
    PARSING_MAX_SAMPLES: int = field(
        default_factory=lambda: _get_int("BIOREMPP_PARSING_MAX_SAMPLES", 1000)
    )

    PARSING_MAX_KOS_PER_SAMPLE: int = field(
        default_factory=lambda: _get_int("BIOREMPP_PARSING_MAX_KOS_PER_SAMPLE", 10000)
    )

    PARSING_MAX_TOTAL_KOS: int = field(
        default_factory=lambda: _get_int("BIOREMPP_PARSING_MAX_TOTAL_KOS", 100000)
    )
    ...
    PROCESSING_TIMEOUT_SECONDS: int = field(
        default_factory=lambda: _get_int("BIOREMPP_PROCESSING_TIMEOUT", 60)
    )

    PROCESSING_MAX_RETRIES: int = field(
        default_factory=lambda: _get_int("BIOREMPP_PROCESSING_MAX_RETRIES", 2)
    )

    PROCESSING_RETRY_DELAY_SECONDS: int = field(
        default_factory=lambda: _get_int("BIOREMPP_PROCESSING_RETRY_DELAY", 1)
    )
