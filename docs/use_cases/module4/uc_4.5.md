# UC-4.5 â€” Gene Presence Map by Metabolic Pathway
...
- **Key columns:**
  ...
  - `genesymbol` â€“ gene symbol associated with the KO(s) for that pathway  
  - `ko` â€“ KEGG Orthology identifier(s) linked to the gene and pathway
...
3. **Extraction of Sampleâ€“Gene Pairs**
...
4. **Rendering as Gene Presence Map**
   ...
   - Points may carry additional hover metadata (e.g., number of distinct KOs per sampleâ€“gene pair).
...
- **Dropdown Menu (Pathway Selection)**
  ...
  - The geneâ€“sample matrix updates automatically for the selected pathway.

- **Y-axis â€“ Gene Symbols**
...
- **Methodological limitation**
  Gene annotation presence is treated as a binary variable, making no distinction between a highly transcribed core gene and a low-copy, weakly expressed pseudogene.

- **Visualization limitation**
  The scatter plot simply maps gene presence to samples, omitting the vital topological information about how these genes are ordered within the metabolic pathway.

- **Interpretive limitation**
  Consistently aligned points indicate broadly shared genetic annotations in the database, not necessarily shared active transcription, functional complementation, or ecological cooperation in vivo.
