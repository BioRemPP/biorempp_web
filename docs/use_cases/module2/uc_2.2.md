...
- **Narrow Association Profiles**
  Samples with shorter bars are co-annotated with fewer unique compounds in the dataset. This may reflect a more focused annotation profile, smaller dataset representation, or a narrower compound scope — not necessarily lower biological activity or relevance.
