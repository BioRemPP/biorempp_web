...
- **Flows (Ribbons)**
  The ribbons connecting nodes represent **co-annotation flows**:
...
<a class="glightbox" href="../uc_6.1_result.png">
    <img src="../uc_6.1_result.png" alt="Representative output for UC-6.1">
</a>
...
- **Tracing Dominant Co-annotation Pathways**
  The **thickest ribbons** may highlight the most prominent co-annotation paths:
  - from a given **Regulatory Agency** through one or more **Samples**,
  - via specific **Genes**,
  - down to their co-annotated **Compounds**.
  These flows may reveal where regulatory compound lists, sample annotations, and gene co-annotations most strongly overlap.
...
- **Regulatory Co-annotation Footprint**
...
- **System-Level Annotation Overview**
  The diagram can provide an **annotation-level overview**:
