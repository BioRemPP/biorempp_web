# UC-8.5 â€” KEGG Pathways Completeness Scorecard
...
- **Key columns:**
  ...
  - `pathname` â€“ KEGG pathway name or identifier associated with the KO  
...
- **Cells (Color and Label)**
  - The **color intensity** of each cell encodes the **Pathway Completeness Score (%)** for that sampleâ€“pathway pair.  
