# UC-8.6 â€” Pathway-Centric Consortium Design by KO Coverage
...
3. **Set Construction (Sample-wise KO Repertoires)**
   ...
   - Each set defines the **pathway-specific KO annotation profile** of that sample.
...
<a class="glightbox" href="../uc_8.6_result.png">
    <img src="../uc_8.6_result.png" alt="Representative output for UC-8.6">
</a>
