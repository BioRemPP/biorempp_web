# UC-3.7 â€” Compound Co-occurrence Across Samples

**Module:** 3 â€“ System Structure: Clustering, Similarity, and Co-occurrence  
**Visualization type:** Compound Ã— compound correlogram (co-occurrence heatmap)  
...
- **Key columns:**
  ...
  - `compoundname` â€“ name (or identifier) of the chemical compound associated with the sample
...
- **Methodological limitation**
  Compound co-occurrence is inferred from binary presence/absence across samples and does not distinguish annotation overlap due to shared curation, co-contamination, chemistry, or biological process.

- **Visualization limitation**
  The heatmap compresses each compound pair into a single correlation score and does not reveal the sample-level contexts or compound classes responsible for the observed association.

- **Interpretive limitation**
  Frequent compound co-occurrence indicates shared annotation patterns, not confirmed pathway connectivity, chemical causality, or environmental co-presence without external evidence.
