# UC-1.2 â€” Overlap of Compounds Across Regulatory References
...
- **Key columns:**
  ...
  - `compoundname` â€“ name of the monitored chemical compound
...
- **Methodological limitation**
  Intersections depend on harmonized compound names and reference labels, so synonym handling and differing regulatory scopes can affect which compounds are counted as shared or exclusive.

- **Visualization limitation**
  The UpSet plot displays overlap cardinalities but does not expose why agencies differ, such as jurisdiction, update date, monitoring criteria, or compound class emphasis.

- **Interpretive limitation**
  Shared compounds across agencies indicate overlapping listing patterns, not equivalent regulatory intent, hazard ranking, or uniform environmental priority across frameworks.
