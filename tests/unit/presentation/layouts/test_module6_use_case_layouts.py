"""Smoke tests for Module 6 use case layout composition."""
...
@pytest.mark.parametrize(
    ("factory", "use_case_id"),
    [
        (create_uc_6_1_layout, "uc-6-1"),
        (create_uc_6_2_layout, "uc-6-2"),
        (create_uc_6_3_layout, "uc-6-3"),
        (create_uc_6_4_layout, "uc-6-4"),
        (create_uc_6_5_layout, "uc-6-5"),
    ],
)
def test_module6_layout_places_info_panel_before_results(
    factory: Callable[[], dbc.Card], use_case_id: str
) -> None:
    """Each Module 6 card should keep the info panel before the results accordion."""
    layout = factory()
